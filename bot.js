...
client.on('message', message => {
    if (message.content === '6help') {
        ...
        .addField('6play', 'لتشغيل اغنية')
        .addField('6join', 'دخول رومك الصوتي')
        .addField('6disconnect', 'الخروج من رومك الصوتي')
        .addField('6skip', 'تخطي الأغنية')
        .addField('6pause', 'ايقاف الاغنية مؤقتا')
        .addField('6resume', 'تكملة الاغنية')
        .addField('6queue', 'اظهار قائمة التشغيل')
        .addField('6np', 'اظهار الاغنية اللي انت مشغلها حاليا')
...
client.user.setGame(`🎶'Music | 6play`)
